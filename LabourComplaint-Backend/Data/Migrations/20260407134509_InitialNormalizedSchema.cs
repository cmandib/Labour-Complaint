        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationPreferencesJson = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Districts_AssignedDistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkplaceName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    AssignedInspectorId = table.Column<int>(type: "integer", nullable: true),
                    ResponseDueBy = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ResolutionDueBy = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Complaints_Users_AssignedInspectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribedDistrictId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDevices_Districts_SubscribedDistrictId",
                        column: x => x.SubscribedDistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatRooms_Complaints_ComplaintId",
                        column: x => x.ComplaintId,
                        principalTable: "Complaints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRooms_Users_CitizenId",
                        column: x => x.CitizenId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRooms_Users_InspectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvidenceItems_Complaints_ComplaintId",
                        column: x => x.ComplaintId,
                        principalTable: "Complaints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvidenceItems_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShouldNotify = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_CitizenId_Status_CreatedAt",
                table: "ChatRooms",
                columns: new[] { "CitizenId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_ComplaintId",
                table: "ChatRooms",
                column: "ComplaintId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_InspectorId_Status_CreatedAt",
                table: "ChatRooms",
                columns: new[] { "InspectorId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Complaint_District_Status_Created",
                table: "Complaints",
                columns: new[] { "DistrictId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Complaints_AssignedInspectorId",
                table: "Complaints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvidenceItems_ComplaintId",
                table: "EvidenceItems",
                column: "ComplaintId");

            migrationBuilder.CreateIndex(
                name: "IX_EvidenceItems_UploadedByUserId",
                table: "EvidenceItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notification_Recipient_Status_Created",
                table: "Notifications",
                columns: new[] { "RecipientId", "Status", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ComplaintId_Type_CreatedAt",
                table: "Notifications",
                columns: new[] { "ComplaintId", "Type", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_Status_Priority_CreatedAt",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDevices_SubscribedDistrictId",
                table: "UserDevices",
                column: "SubscribedDistrictId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AssignedDistrictId",
                table: "Users",
