        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenIdentifier = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlacklistedTokens_TokenIdentifier_IsDeleted",
                table: "BlacklistedTokens",
                columns: new[] { "TokenIdentifier", "IsDeleted" },
                unique: true);
        }
